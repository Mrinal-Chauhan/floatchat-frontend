        ...
        <>
            ...
            <section className="hero-section">
                ...
                <div className="buttons">
                    ...
                    <Link to="/chatbot" className="btn secondary"> Start A Chat </Link>
                </div>
            </section>
                ...
                <section className="about-section">
                    <div className="about-container">
                        ...
                        <div className="about-text">
                            ...
                            <p>
                                Autonomous ocean floats like this silently drift across the world’s oceans, diving up to 2000 meters below the surface to measure temperature, salinity, and other vital parameters. Every 10 days, they resurface to transmit data via satellites, contributing to the world’s largest real-time ocean observation network.
                            </p>
                            <p>
                                With <strong>FloatChat</strong>, this complex data becomes simple — our AI-powered interface lets you explore, query, and visualize Argo measurements effortlessly, turning raw science into actionable insights.
                            </p>
                        </div>
                    </div>
                </section>
                ...
                <section className="about-section">
                    <div className="about-container reverse">
                        ...
                        <div className="about-text">
                            ...
                            <p>
                                Traditionally, only experts could access and analyze global ocean datasets. With <strong>FloatChat</strong>, anyone can chat with the data, visualize global patterns, and uncover insights from the world’s oceans — all through a simple interface.
                            </p>
                        </div>
                        {/* Right: Image */}
                        <div className="about-image">
